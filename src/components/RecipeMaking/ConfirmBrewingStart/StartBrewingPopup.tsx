      ...
      <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
        ...
        <div className="bg-gray-50 px-4 py-3 ">
          ...
          <div className="grid justify-items-stretch mt-8">
            <button
              type="button"
              className="mt-3 w-full inline-flex bg-green-400 hover:bg-green-600 justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700  sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
